...
//                        m.MovieName,
//                        m.Poster,
//                        Rating = ratings.Where(r => r.MovieId == m.MovieId).Any() 
//                            ? Math.Round(ratings.Where(r => r.MovieId == m.MovieId).Average(r => r.RatingValue), 1) 
//                            : 0,
//                        m.ViewCount,
//                        m.createdAt
//                    }),
...
//                                : 0,
//                            m.ViewCount,
//                            RatingCount = ratings.Count(r => r.MovieId == m.MovieId)
//                        })
